...
import ProductList from "../components/Layout/Operations/ProductList/ProductList";
...
const Operations = () => {
  ...
  return (
    <>
      <Header />
      {selectedItem === 0 && (
        <OperationsMenu selectedItem={itemChangeHandler} />
      )}
      {selectedItem === 1 && <AddProduct selectedItem={itemChangeHandler} />}
      {selectedItem === 2 && <ProductList selectedItem={itemChangeHandler} />}
